...
5.  左側のナビゲーションのツリービューから、 **[DetailScreen]** を選択します。
...
9.  左側のナビゲーションにあるツリービューから、 **[EditScreen]** を選びます (ツリービューでこれを表示するには、必要に応じて下にスクロールする必要がある場合があります)。
...
13. 左側のナビゲーションにあるツリー ビューを使用して、 **[BrowseScreen]** を選択します。
...
2.  左側のナビゲーションから、 **[BrowseScreen]** を選択します。
