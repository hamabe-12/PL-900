...
4. **[Excel または .CSVファイルで作成する]** を選択します。

5. **[デバイスから選択]** ボタンをクリックします。

6. タスク \#1でダウンロードした **[Visits.xlsx]** ファイルを見つけて選択します。  (このファイルのアップロードには、1 から 2 分かかる場合があります。）

7. Excleデータがテーブル作成画面に反映され、**[イベントスケジュール]** の右側にある **[鉛筆アイコン]** をクリックすると、テーブルの編集画面が表示されて、下記に示す通りに編集を行い、**[保存]** をクリックします。
...
9. **[code]** 列を編集します。
    ...
    - 高度なオプションを展開、**[スキーマ名]** に「**Code**」を入力します。
    
    - **[更新]** ボタンをクリックします。
    
10. **[scheduled start]** 列を編集します。

    - **[scheduled start]** をクリックします。
...
11. **[scheduled end]** 列を編集します。

    - **[scheduled end]** をクリックします。
...
12. **[actual start]** 列を編集します。

    - **[actual start]** をクリックします。
    ...
    - 高度なオプションを展開、**[スキーマ名]** に「**ActualStart**」を入力します。
    
    - **[更新]** ボタンをクリックします。
    
13. **[actual end]** 列を編集します。
    ...
    - 高度なオプションを展開、**[スキーマ名]** に「**ActualEnd**」を入力します。
    
    - **[更新]** ボタンをクリックします。
    
14. **[作成]** ボタンをクリックします。
    少し時間を経ったら、作成された [訪問] テーブル画面が表示され、そして Visits.xlsx データが [訪問 列とデータ] セクションに表示されていることを確認できます。
